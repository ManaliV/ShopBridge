...
namespace ShopBridge.Web.Helpers
{
    public static class SampleDataProvider
    {
        ...
        private static async Task TestDataSeed(ApplicationDbContext context, IConfigurationRoot configuration)
        {
            ...
            {
                new BillingAddress { Id = BillingAddressIds.Billing0.GetGuid(), FirstName = "user", LastName = "ShopBridge", Email = configuration.GetValue<string>("UserAccount:Email"), Address = "localhost", City = "localhost", StateProvince = "localhost", ZipPostalCode = "11234", Country = "localhost", Telephone = "0123456789" },
                new BillingAddress { Id = BillingAddressIds.Billing1.GetGuid(), FirstName = "user", LastName = "ShopBridge", Email = configuration.GetValue<string>("UserAccount:Email"), Address = "localhost", City = "localhost", StateProvince = "localhost", ZipPostalCode = "11234", Country = "localhost", Telephone = "0123456789" },
                new BillingAddress { Id = BillingAddressIds.Billing2.GetGuid(), FirstName = "user", LastName = "ShopBridge", Email = configuration.GetValue<string>("UserAccount:Email"), Address = "localhost", City = "localhost", StateProvince = "localhost", ZipPostalCode = "11234", Country = "localhost", Telephone = "0123456789" }
            };
