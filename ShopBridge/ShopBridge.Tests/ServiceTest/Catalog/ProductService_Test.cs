...
namespace ShopBridge.xUnitTest.ServiceTest.Catalog
{
    public class ProductService_Test
    {
        ...
        public void ProductService_Test_GetAllProducts()
        {
            ...
            {
                new Product() { Id = Guid.NewGuid(), Name = "Mouse", Price = 100m },
                new Product() { Id = Guid.NewGuid(), Name = "KeyBoard", Price = 100m },
                new Product() { Id = Guid.NewGuid(), Name = "Screen", Price = 100m }
            };
        ...
        public void ProductService_Test_GetProductById()
        {
            ...
            var productEntity = new Product() { Id = Guid.NewGuid(), Name = "Mouse", Price = 100m };
        ...
        public void ProductService_Test_GetProductBySeo()
        {
            ...
            var productEntity = new Product() { Id = Guid.NewGuid(), Name = "Mouse", Price = 100m, SeoUrl = "Mouse" };
        ...
        public void ProductService_Test_UpdateProduct()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                ...
                // act
                productEntity.Name = "Mouse Updated";
                service.ProductService.UpdateProduct(productEntity);

                // assert
                Assert.Equal("Mouse Updated", service.ProductService.GetAllProducts().Single().Name);
            }
        }
